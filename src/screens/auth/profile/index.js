...
import { rhp, colors, Strings, ScreenNames, hp, wp } from '../../../constants';
...
const ProfileScreen = () => {
  ...
  return (
    <ImageBackground source={images.backgroundImage} style={styles.container}>
      ...
      />
      <Text style={styles.selectedTextDisplay}>{`${Strings.age} ${age}`}</Text>

      {/* {errorMessage && ToastAndroid.show(errorMessage, ToastAndroid.LONG)} */}
      <View style={{ flex: 1 }} />
      <TouchableButton
        title="Next"
        btnPropStyle={{ marginBottom: hp(6), width: wp(80) }}
